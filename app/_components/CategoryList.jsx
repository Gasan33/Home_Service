    ...
    return (
        <div className='mx-4 md:mx-22 lg:mx-52 grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 '>
            ...
            {categoryList.map((category, index) => (
                <Link href={'/search/' + category.name} key={index} className={`flex flex-col items-center justify-center gap-2 bg-[${category.bgcolor.hex}] p-5 rounded-lg cursor-pointer hover:scale-110 transition-all ease-in-out `}>
